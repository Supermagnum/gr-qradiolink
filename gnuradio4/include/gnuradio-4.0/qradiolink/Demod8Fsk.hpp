...
#ifndef GNURADIO4_QRAD_DEMOD8FSK_HPP
#define GNURADIO4_QRAD_DEMOD8FSK_HPP
...
GR_REGISTER_BLOCK(gnuradio4::qradiolink::Demod8Fsk)

struct Demod8Fsk : gr::Block<Demod8Fsk> {
    ...
    GR_MAKE_REFLECTABLE(Demod8Fsk, in, out, samples_per_symbol, frequency_separation_hz);
...
public:
    [[nodiscard]] gr::work::Status processBulk(std::span<const std::complex<float>>& in_span, std::span<std::uint8_t>& out_span) noexcept {
        ...
        const unsigned    bps         = detail::bitsPerSymbolDigital(detail::DigitalKind::Fsk8);
        ...
        detail::digitalDemodulateHardBits(detail::DigitalKind::Fsk8, in_span, bit_view, sps_local, frequency_separation_hz);
...
#endif // GNURADIO4_QRAD_DEMOD8FSK_HPP
