...
#ifndef GNURADIO4_QRAD_MODCPM4FSK_HPP
#define GNURADIO4_QRAD_MODCPM4FSK_HPP
...
GR_REGISTER_BLOCK(gnuradio4::qradiolink::ModCpm4Fsk)

struct ModCpm4Fsk : gr::Block<ModCpm4Fsk> {
    ...
    GR_MAKE_REFLECTABLE(ModCpm4Fsk, in, out, samples_per_symbol, sample_rate_hz, carrier_offset_hz, frequency_separation_hz);
...
public:
    [[nodiscard]] gr::work::Status processBulk(std::span<const std::uint8_t>& in_span, std::span<std::complex<float>>& out_span) noexcept {
        ...
        detail::digitalModulateWaveform(detail::DigitalKind::Cpm4FskLike,
            in_span,
...
#endif // GNURADIO4_QRAD_MODCPM4FSK_HPP
