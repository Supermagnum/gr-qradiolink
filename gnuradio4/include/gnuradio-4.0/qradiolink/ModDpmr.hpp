...
#ifndef GNURADIO4_QRAD_MODDPMR_HPP
#define GNURADIO4_QRAD_MODDPMR_HPP
...
GR_REGISTER_BLOCK(gnuradio4::qradiolink::ModDpmr)

struct ModDpmr : gr::Block<ModDpmr, gr::NoTagPropagation> {
    using Description = gr::Doc<"PDU shim (deterministic transforms for qa).">;
    gr::MsgPortIn  msg_pdu_in{};
    gr::MsgPortOut msg_pdu_out{};

    GR_MAKE_REFLECTABLE(ModDpmr, msg_pdu_in, msg_pdu_out);
