...
#ifndef GNURADIO4_QRAD_P25ENCODER_HPP
#define GNURADIO4_QRAD_P25ENCODER_HPP
...
GR_REGISTER_BLOCK(gnuradio4::qradiolink::P25Encoder)

struct P25Encoder : gr::Block<P25Encoder, gr::NoTagPropagation> {
    using Description = gr::Doc<"PDU shim (deterministic transforms for qa).">;
    gr::MsgPortIn  msg_pdu_in{};
    gr::MsgPortOut msg_pdu_out{};

    GR_MAKE_REFLECTABLE(P25Encoder, msg_pdu_in, msg_pdu_out);
