...
#ifndef GNURADIO4_QRAD_DSTARENCODER_HPP
#define GNURADIO4_QRAD_DSTARENCODER_HPP
...
GR_REGISTER_BLOCK(gnuradio4::qradiolink::DstarEncoder)

struct DstarEncoder : gr::Block<DstarEncoder, gr::NoTagPropagation> {
    using Description = gr::Doc<"PDU shim (deterministic transforms for qa).">;
    gr::MsgPortIn  msg_pdu_in{};
    gr::MsgPortOut msg_pdu_out{};

    GR_MAKE_REFLECTABLE(DstarEncoder, msg_pdu_in, msg_pdu_out);
