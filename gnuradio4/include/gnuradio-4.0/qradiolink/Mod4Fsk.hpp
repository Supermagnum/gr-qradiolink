...
#ifndef GNURADIO4_QRAD_MOD4FSK_HPP
#define GNURADIO4_QRAD_MOD4FSK_HPP
...
GR_REGISTER_BLOCK(gnuradio4::qradiolink::Mod4Fsk)

struct Mod4Fsk : gr::Block<Mod4Fsk> {
    ...
    GR_MAKE_REFLECTABLE(Mod4Fsk, in, out, samples_per_symbol, sample_rate_hz, carrier_offset_hz, frequency_separation_hz);
...
public:
    [[nodiscard]] gr::work::Status processBulk(std::span<const std::uint8_t>& in_span, std::span<std::complex<float>>& out_span) noexcept {
        ...
        detail::digitalModulateWaveform(detail::DigitalKind::Fsk4,
            in_span,
...
#endif // GNURADIO4_QRAD_MOD4FSK_HPP
