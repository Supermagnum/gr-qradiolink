...
#ifndef GNURADIO4_QRAD_MODNXDN_HPP
#define GNURADIO4_QRAD_MODNXDN_HPP
...
GR_REGISTER_BLOCK(gnuradio4::qradiolink::ModNxdn)

struct ModNxdn : gr::Block<ModNxdn, gr::NoTagPropagation> {
    using Description = gr::Doc<"PDU shim (deterministic transforms for qa).">;
    gr::MsgPortIn  msg_pdu_in{};
    gr::MsgPortOut msg_pdu_out{};

    GR_MAKE_REFLECTABLE(ModNxdn, msg_pdu_in, msg_pdu_out);
