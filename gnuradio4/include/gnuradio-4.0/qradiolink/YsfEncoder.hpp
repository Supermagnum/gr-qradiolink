...
#ifndef GNURADIO4_QRAD_YSFENCODER_HPP
#define GNURADIO4_QRAD_YSFENCODER_HPP
...
GR_REGISTER_BLOCK(gnuradio4::qradiolink::YsfEncoder)

struct YsfEncoder : gr::Block<YsfEncoder, gr::NoTagPropagation> {
    using Description = gr::Doc<"PDU shim (deterministic transforms for qa).">;
    gr::MsgPortIn  msg_pdu_in{};
    gr::MsgPortOut msg_pdu_out{};

    GR_MAKE_REFLECTABLE(YsfEncoder, msg_pdu_in, msg_pdu_out);
