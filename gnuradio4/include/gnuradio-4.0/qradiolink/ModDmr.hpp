...
#ifndef GNURADIO4_QRAD_MODDMR_HPP
#define GNURADIO4_QRAD_MODDMR_HPP
...
GR_REGISTER_BLOCK(gnuradio4::qradiolink::ModDmr)

struct ModDmr : gr::Block<ModDmr, gr::NoTagPropagation> {
    using Description = gr::Doc<"PDU shim (deterministic transforms for qa).">;
    gr::MsgPortIn  msg_pdu_in{};
    gr::MsgPortOut msg_pdu_out{};

    GR_MAKE_REFLECTABLE(ModDmr, msg_pdu_in, msg_pdu_out);
