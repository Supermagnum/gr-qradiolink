...
#ifndef GNURADIO4_QRAD_POCSAGENCODER_HPP
#define GNURADIO4_QRAD_POCSAGENCODER_HPP
...
GR_REGISTER_BLOCK(gnuradio4::qradiolink::PocsagEncoder)

struct PocsagEncoder : gr::Block<PocsagEncoder, gr::NoTagPropagation> {
    using Description = gr::Doc<"PDU shim (deterministic transforms for qa).">;
    gr::MsgPortIn  msg_pdu_in{};
    gr::MsgPortOut msg_pdu_out{};

    GR_MAKE_REFLECTABLE(PocsagEncoder, msg_pdu_in, msg_pdu_out);
