...
#ifndef GNURADIO4_QRAD_M17CODER_HPP
#define GNURADIO4_QRAD_M17CODER_HPP
...
GR_REGISTER_BLOCK(gnuradio4::qradiolink::M17Coder)

struct M17Coder : gr::Block<M17Coder, gr::NoTagPropagation> {
    using Description = gr::Doc<"PDU shim (deterministic transforms for qa).">;
    gr::MsgPortIn  msg_pdu_in{};
    gr::MsgPortOut msg_pdu_out{};

    GR_MAKE_REFLECTABLE(M17Coder, msg_pdu_in, msg_pdu_out);
