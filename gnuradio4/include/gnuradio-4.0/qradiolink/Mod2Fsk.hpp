...
#ifndef GNURADIO4_QRAD_MOD2FSK_HPP
#define GNURADIO4_QRAD_MOD2FSK_HPP
...
GR_REGISTER_BLOCK(gnuradio4::qradiolink::Mod2Fsk)

struct Mod2Fsk : gr::Block<Mod2Fsk> {
    ...
    GR_MAKE_REFLECTABLE(Mod2Fsk, in, out, samples_per_symbol, sample_rate_hz, carrier_offset_hz, frequency_separation_hz);
...
#endif // GNURADIO4_QRAD_MOD2FSK_HPP
