...
struct YSFEncoder : gr::Block<YSFEncoder> {
    using Description = gr::Doc<"GR4 port placeholder — implement from GR3 ysf_encoder_impl.cc.">;

    gr::PortIn<std::uint8_t>   in{};
    gr::PortOut<std::uint8_t>  out{};

    GR_MAKE_REFLECTABLE(YSFEncoder, in, out);
