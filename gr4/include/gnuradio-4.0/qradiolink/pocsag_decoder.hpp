...
struct POCSAGDecoder : gr::Block<POCSAGDecoder> {
    using Description = gr::Doc<"GR4 port placeholder — implement from GR3 pocsag_decoder_impl.cc.">;

    gr::PortIn<std::uint8_t>   in{};
    gr::PortOut<std::uint8_t>  out{};

    GR_MAKE_REFLECTABLE(POCSAGDecoder, in, out);
