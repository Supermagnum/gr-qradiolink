...
struct DStarEncoder : gr::Block<DStarEncoder> {
    using Description = gr::Doc<"GR4 port placeholder — implement from GR3 dstar_encoder_impl.cc.">;

    gr::PortIn<std::uint8_t>   in{};
    gr::PortOut<std::uint8_t>  out{};

    GR_MAKE_REFLECTABLE(DStarEncoder, in, out);
