...
struct M17Deframer : gr::Block<M17Deframer> {
    using Description = gr::Doc<"GR4 port placeholder — implement from GR3 m17_deframer_impl.cc.">;

    gr::PortIn<std::uint8_t>   in{};
    gr::PortOut<std::uint8_t>  out{};

    GR_MAKE_REFLECTABLE(M17Deframer, in, out);
