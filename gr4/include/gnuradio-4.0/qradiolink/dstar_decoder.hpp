...
struct DStarDecoder : gr::Block<DStarDecoder> {
    using Description = gr::Doc<"GR4 port placeholder — implement from GR3 dstar_decoder_impl.cc.">;

    gr::PortIn<std::uint8_t>   in{};
    gr::PortOut<std::uint8_t>  out{};

    GR_MAKE_REFLECTABLE(DStarDecoder, in, out);
