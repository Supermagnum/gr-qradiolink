...
struct InterleaverBB : gr::Block<InterleaverBB> {
    using Description = gr::Doc<"GR4 port placeholder — GR3 interleaver_bb_impl.cc">;

    gr::PortIn<std::uint8_t>   in{};
    gr::PortOut<std::uint8_t>  out{};

    GR_MAKE_REFLECTABLE(InterleaverBB, in, out);
