...
struct YSFDecoder : gr::Block<YSFDecoder> {
    using Description = gr::Doc<"GR4 port placeholder — implement from GR3 ysf_decoder_impl.cc.">;

    gr::PortIn<std::uint8_t>   in{};
    gr::PortOut<std::uint8_t>  out{};

    GR_MAKE_REFLECTABLE(YSFDecoder, in, out);
