...
struct POCSAGEncoder : gr::Block<POCSAGEncoder> {
    using Description = gr::Doc<"GR4 port placeholder — implement from GR3 pocsag_encoder_impl.cc.">;

    gr::PortIn<std::uint8_t>   in{};
    gr::PortOut<std::uint8_t>  out{};

    GR_MAKE_REFLECTABLE(POCSAGEncoder, in, out);
