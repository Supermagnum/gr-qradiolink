...
test_vector_dpmr_data_valid_2 = {
    ...
    "validation": {
        "sync_detection": True,
        "crc_valid": True,
        "data_decode": {"latitude": 59.9139, "longitude": 10.7522},
    },
}
...
test_vector_nxdn_voice_valid_1 = {
    ...
    "frame_bits": {
        ...
        "voice_data_scrambled": (
            "10110010" * 28 + "1011"  # Simplified - real AMBE data  # Padding
        ),
...
def get_test_vectors(protocol=None, validity=None):
    ...
    if validity is None:
        return (
            ALL_TEST_VECTORS[protocol]["valid"] + ALL_TEST_VECTORS[protocol]["invalid"]
        )
    elif validity == "valid":
