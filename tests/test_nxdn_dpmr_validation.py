...
from test_vectors_nxdn_dpmr import get_test_vectors  # noqa: E402
...
def generate_test_signal(test_vector, sample_rate=1000000):
    ...
    # Note: symbols variable is computed but not used in current implementation
    # bits_to_symbols(frame_bits, test_vector["symbol_map"])
...
def test_demodulator(test_vector, verbose=True):
    ...
    if verbose:
        ...
        print("  This would test sync detection, FEC decoding, descrambling")
