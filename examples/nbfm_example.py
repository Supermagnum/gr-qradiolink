...
class NbfmExample(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.setWindowTitle("NBFM Example")
        ...
        for i in range(1):
            if len(labels[i]) == 0:
                self.qtgui_time_sink_f_0.set_line_label(i, "Data {0}".format(i))
            else:
                self.qtgui_time_sink_f_0.set_line_label(i, labels[i])
            self.qtgui_time_sink_f_0.set_line_width(i, widths[i])
            self.qtgui_time_sink_f_0.set_line_color(i, colors[i])
            self.qtgui_time_sink_f_0.set_line_style(i, styles[i])
        ...
        for i in range(1):
            if len(labels[i]) == 0:
                self.qtgui_freq_sink_c_0.set_line_label(i, "Data {0}".format(i))
            else:
                self.qtgui_freq_sink_c_0.set_line_label(i, labels[i])
            self.qtgui_freq_sink_c_0.set_line_width(i, widths[i])
        ...
        # Connections
        ##################################################
        self.connect((self.audio_source, 0), (self.nbfm_mod, 0))
        self.connect((self.blocks_throttle2_0, 0), (self.nbfm_demod, 0))
        self.connect((self.blocks_throttle2_0, 0), (self.qtgui_freq_sink_c_0, 0))
        self.connect((self.nbfm_demod, 0), (self.blocks_null_sink_0, 0))
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.qtgui_freq_sink_c_0.set_frequency_range(0, self.samp_rate)
        self.qtgui_time_sink_f_0.set_samp_rate(self.samp_rate)
