...
#ifndef INCLUDED_QRADIOLINK_MOD_8FSK_IMPL_H
#define INCLUDED_QRADIOLINK_MOD_8FSK_IMPL_H
...
class mod_8fsk_impl : public mod_8fsk
{
private:
...
#endif /* INCLUDED_QRADIOLINK_MOD_8FSK_IMPL_H */
