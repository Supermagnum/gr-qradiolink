...
#ifndef INCLUDED_QRADIOLINK_DEMOD_8FSK_IMPL_H
#define INCLUDED_QRADIOLINK_DEMOD_8FSK_IMPL_H
...
class demod_8fsk_impl : public demod_8fsk
{
private:
...
public:
    demod_8fsk_impl(int sps, int samp_rate, int carrier_freq, int filter_width, bool fm);
    ~demod_8fsk_impl();
};
...
#endif /* INCLUDED_QRADIOLINK_DEMOD_8FSK_IMPL_H */
