...
#ifndef INCLUDED_QRADIOLINK_DEMOD_MMDVM_MULTI2_IMPL_H
#define INCLUDED_QRADIOLINK_DEMOD_MMDVM_MULTI2_IMPL_H
...
class demod_mmdvm_multi2_impl : public demod_mmdvm_multi2
{
private:
    ...
    gr::blocks::null_sink::sptr d_null_sink[10];
...
public:
    demod_mmdvm_multi2_impl(BurstTimer* burst_timer,
                            int num_channels,
...
#endif /* INCLUDED_QRADIOLINK_DEMOD_MMDVM_MULTI2_IMPL_H */
