...
#ifndef INCLUDED_QRADIOLINK_M17_DECODER_H
#define INCLUDED_QRADIOLINK_M17_DECODER_H
...
/*!
 * \brief M17 Protocol Decoder
 * \ingroup qradiolink
 *
 * This block implements the M17 protocol layer decoder, handling syncword detection,
 * frame decoding, decryption (AES/Scrambler), and ECDSA signature verification.
 * Works with demod_m17 for complete M17 reception.
 */
    class QRADIOLINK_API m17_decoder:virtual public gr::block
    {
    public:
	...
	ENCR_RES		//reserved
      ...
      /*!
       * \brief Return a shared_ptr to a new instance of qradiolink::m17_decoder.
       *
       * To avoid accidental use of raw pointers, qradiolink::m17_decoder's
       * constructor is in a private implementation
       * class. qradiolink::m17_decoder::make is the public interface for
...
#endif				/* INCLUDED_QRADIOLINK_M17_DECODER_H */
