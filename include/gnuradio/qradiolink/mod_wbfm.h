...
#ifndef INCLUDED_QRADIOLINK_MOD_WBFM_H
#define INCLUDED_QRADIOLINK_MOD_WBFM_H
...
/*!
 * \brief WBFM (Wide Band FM) Modulator
 * \ingroup qradiolink
 *
 * This block implements a Wide Band FM modulator with pre-emphasis.
 */
class QRADIOLINK_API mod_wbfm : public hier_block2
{
public:
    typedef std::shared_ptr<mod_wbfm> sptr;

    /*!
     * \brief Make a WBFM modulator block
     *
...
protected:
    mod_wbfm(const std::string& name,
...
#endif /* INCLUDED_QRADIOLINK_MOD_WBFM_H */
