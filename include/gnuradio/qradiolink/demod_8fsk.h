...
#ifndef INCLUDED_QRADIOLINK_DEMOD_8FSK_H
#define INCLUDED_QRADIOLINK_DEMOD_8FSK_H
...
/*!
 * \brief 8FSK Demodulator with CCSDS decoding
 * \ingroup qradiolink
 *
 * This block implements an 8-level Frequency Shift Keying (8FSK) demodulator
 * with CCSDS convolutional decoding and descrambling.
 */
class QRADIOLINK_API demod_8fsk : public hier_block2
{
public:
    typedef std::shared_ptr<demod_8fsk> sptr;

    /*!
     * \brief Make an 8FSK demodulator block
     *
     * Outputs:
...
protected:
    demod_8fsk(const std::string& name,
...
#endif /* INCLUDED_QRADIOLINK_DEMOD_8FSK_H */
